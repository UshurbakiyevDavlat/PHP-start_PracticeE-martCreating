                        ...
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <a href="index.php/products/<?php echo $latItem['id'];?>" class="btn btn-default "><i class="fa "></i>Подробнее</a>
                                    <a href="index.php/cart/addToCart/<?php echo $latItem['id'];?>" class="btn btn-default add-to-cart"  data-id = "<?php
